/*
  ...
  gengetopt --file-name=client_args 
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -p, --porto=INT  UDP Socket bind port",
  "  -i, --ip=STRING  IP Servidor",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ip_help = gengetopt_args_info_help[3] ;
