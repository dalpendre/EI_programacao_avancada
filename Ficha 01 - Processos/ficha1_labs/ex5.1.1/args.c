...
const char *gengetopt_args_info_purpose = "Ex5.1.1 da Ficha 1 - Processos";

const char *gengetopt_args_info_usage = "Usage: Ex5.1.1 [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -n, --num_procs=INT  Numero de processos",
    0
};
