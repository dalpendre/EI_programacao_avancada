...
const char *gengetopt_args_info_usage = "Usage: Client [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --ip=STRING    IP adddress",
  "      --port=INT     Port number",
  "      --word=STRING  Word to invert",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->word_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->word_given)
    {
      fprintf (stderr, "%s: '--word' option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Word to invert.  */
          else if (strcmp (long_options[option_index].name, "word") == 0)
          {
