...
const char *gengetopt_args_info_help[] = {
  ...
  "  -p, --port=INT         Listening port number",
  "  -f, --filename=STRING  Ficheiro a enviar ao cliente",
    0
};
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVp:f:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* Listening port number.  */
          ...
          break;
        case 'f':	/* Ficheiro a enviar ao cliente.  */
