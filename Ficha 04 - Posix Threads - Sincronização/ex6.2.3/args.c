...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT      número de threads a usar",
  "  -f, --ficheiro=STRING  ficheiro a contar",
  "  -b, --bloco=INT        bloco de bytes a contar",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->ficheiro_help = gengetopt_args_info_help[3] ;
  args_info->bloco_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->bloco_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->bloco_given)
    write_into_file(outfile, "bloco", args_info->bloco_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->ficheiro_given)
    {
      fprintf (stderr, "%s: '--ficheiro' ('-f') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->bloco_given)
    {
      fprintf (stderr, "%s: '--bloco' ('-b') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 't':	/* número de threads a usar.  */
        ...
        case 'f':	/* ficheiro a contar.  */
          ...
          break;
        case 'b':	/* bloco de bytes a contar.  */
        
        
          if (update_arg( (void *)&(args_info->bloco_arg), 
               &(args_info->bloco_orig), &(args_info->bloco_given),
              &(local_args_info.bloco_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "bloco", 'b',
              additional_error))
            goto failure;
