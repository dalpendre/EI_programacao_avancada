...
const char *gengetopt_args_info_purpose = "Ficha 02 - Sinais";

const char *gengetopt_args_info_usage = "Usage: showFirst [OPTIONS]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Exercício 3.1.1";

const char *gengetopt_args_info_help[] = {
  "  -h, --help         Print help and exit",
  "  -V, --version      Print version and exit",
  "  -f, --file=STRING  opção para indicar file",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* opção para indicar file.  */
